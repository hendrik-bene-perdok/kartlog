...
- TypeScript 5.x, Next.js 16 (React 19) + Firebase v9 (Auth), Tailwind CSS 4, Zod 4.x (005-require-auth)
- Firestore (existing), IndexedDB (existing) (005-require-auth)
...
## Recent Changes
- 005-require-auth: Added TypeScript 5.x, Next.js 16 (React 19) + Firebase v9 (Auth), Tailwind CSS 4, Zod 4.x
