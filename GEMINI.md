...
- TypeScript 5.x, Next.js 16 (React 19) + Tailwind CSS v4, Firebase v9 (Firestore), Zod 4.x (001-dashboard-refactor)
- Firestore (Persistence Enabled), IndexedDB (001-dashboard-refactor)
...
## Recent Changes
- 001-dashboard-refactor: Added TypeScript 5.x, Next.js 16 (React 19) + Tailwind CSS v4, Firebase v9 (Firestore), Zod 4.x
