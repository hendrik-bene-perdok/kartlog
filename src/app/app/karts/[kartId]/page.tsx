...
export default function KartDetailPage() {
    ...
    const { kart, loading, error } = useSingleKart(team?.id || '', kartId);
        ...
        <ErrorBoundary>
            <div className={`min-h-screen bg-gradient-to-b ${warningColorClasses[warningColor]} p-4 pb-24`}>
                ...
                <div className="max-w-4xl mx-auto mb-6">
                    <Link href="/app/karts" className="text-blue-400 hover:text-blue-300 mb-4 inline-block">
                        ← Back to Garage
                    </Link>
                ...
                <div className="max-w-4xl mx-auto grid grid-cols-1 gap-4 mb-6">
                    <Link href={`/app/karts/${kartId}/hours`}>
                        <TouchButton variant="primary" size="lg" className="w-full">
                            📝 Log Hours
                        </TouchButton>
                    </Link>

                    <Link href={`/app/karts/${kartId}/settings`}>
                ...
                {showDeleteDialog && (
                    <DeleteKartDialog
                        ...
                        onDeleted={() => router.push('/app/karts')}
                    />
                )}
            </div>
        </ErrorBoundary>
