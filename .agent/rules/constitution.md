...
**This is the Supreme Law of the codebase.**  
It defines the non-negotiable standards for how we build, ship, and operate software.
...
**Documentation is a first-class citizen. It lives with the code.**
